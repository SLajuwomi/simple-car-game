...
# set title
pygame.display.set_caption("Basic Car Game")
# set background colour
screen.fill((60, 100, 0))
# draw graphics
pygame.draw.rect(screen, (50, 50, 50), (width/2 - road_width/2, 0, road_width, height))
pygame.draw.rect(screen, (255, 255, 0), (width/2 - roadmark_width/2, 0, roadmark_width, height))
...
car2_location.center = width/2 - road_width/4, height *0.2
